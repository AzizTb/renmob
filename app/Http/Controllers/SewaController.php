...
class SewaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $sewa = new Sewa;
        $sewa->tgl_sekarang = $request->tgl_sekarang;
        $sewa->nama_lengkap = $request->nama_lengkap;
        $sewa->alamat_sewa = $request->alamat_sewa;
        $sewa->tgl_mulai_sewa = $request->tgl_mulai_sewa;
        $sewa->tgl_selesai_sewa = $request->tgl_selesai_sewa;
        $mobil = mobil::all()->nama_mobil;
        $driver = driver::all()->nama_driver;
        $sewa->save();
        return redirect()->route('sewa.index', compact('sewa', 'mobil', 'driver'));
